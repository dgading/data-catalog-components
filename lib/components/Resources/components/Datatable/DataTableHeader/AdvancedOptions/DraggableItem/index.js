...
function (_Component) {
  ...
  (0, _createClass2["default"])(DraggableItem, [{
    ...
    value: function render() {
      ...
      return this.props.connectDropTarget(this.props.connectDragSource(_react["default"].createElement("div", {
        style: {
      ...
      }, _react["default"].createElement(ItemControl, null)), _react["default"].createElement("label", null, _react["default"].createElement("input", {
...
DraggableItem.propTypes = {
  ...
  connectDragTarget: _propTypes["default"].func
};
...
var _default = (0, _reactDnd.DropTarget)('ITEM', {
  ...
  beginDrag: function beginDrag(props, monitor, collect) {

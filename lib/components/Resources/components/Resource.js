...
var _DataTableHeader = _interopRequireDefault(require("./DataTable/DataTableHeader"));
...
var Resource = function Resource(_ref) {
  ...
  }, dataInfo.data && _react["default"].createElement(_dataCatalogComponents.FileDownload, {
    resource: dataInfo.data,
    key: dataKey
  }), !hideHeader && _react["default"].createElement(_DataTableHeader["default"], {
    dataPreview: dataPreview,
    options: headerOptions,
    dataFunctions: dataFunctions
  }), hideHeader && _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("strong", null, "Rows:"), " ", dataPreview.rowsTotal), _react["default"].createElement(_DataTable["default"], {
    index: 1,
    key: dataKey,
    loading: show,
    pageSize: pageSize,

...
function (_React$PureComponent) {
  _inherits(BasicBlock, _React$PureComponent);

  function BasicBlock() {
    _classCallCheck(this, BasicBlock);

    return _possibleConstructorReturn(this, _getPrototypeOf(BasicBlock).apply(this, arguments));
  }

  _createClass(BasicBlock, [{
    key: "render",

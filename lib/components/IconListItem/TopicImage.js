...
function (_React$PureComponent) {
  _inherits(TopicImage, _React$PureComponent);

  function TopicImage() {
    _classCallCheck(this, TopicImage);

    return _possibleConstructorReturn(this, _getPrototypeOf(TopicImage).apply(this, arguments));
  }

  _createClass(TopicImage, [{
    key: "render",
